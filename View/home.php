...
<html lang="es">
  ...
  <body>
    ...
    <div
      ...
      style="background-image: url('images/portada2.jpg')"
      ...
      <div class="container">
        ...
        >
          <div class="col-md-11 ftco-animate text-center">
            <h1 class="mb-4">
              Atención de la más alta calidad para tus mascotas.
            </h1>
            <p>
              <a href="#" class="btn btn-primary mr-md-4 py-3 px-4"
                >Aprende más <span class="ion-ios-arrow-forward"></span
              ></a>
            </p>
          </div>
        </div>
          ...
          <div class="col-md-4 d-flex align-self-stretch px-4 ftco-animate">
            <div class="d-block services active text-center">
              ...
              <div class="media-body">
                ...
                <p>
                  Muy lejos, detrás de las montañas de palabras, lejos de los
                  países de Vokalia y Consonantia, viven los textos ciegos.
              ...
              <div class="card">
                <div class="card-header p-0" id="headingOne">
                  <h2 class="mb-0">
                    ...
                    >
                      <p class="mb-0">¿Cómo entrenar a tu perro?</p>
                ...
                >
                  <div class="card-body py-3 px-0">
                    <ol>
                      <li>Muy lejos, detrás de las montañas de palabras</li>
                      <li>Consonantia, viven los textos ciegos</li>
                      <li>
                        Cuando llegó a las primeras colinas de las Montañas
                        Itálicas
                      </li>
                      <li>Bookmarksgrove, el titular de Alphabet Village</li>
                      <li>Separados, viven en Bookmarksgrove</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="card">
                <div class="card-header p-0" id="headingThree" role="tab">
                  <h2 class="mb-0">
                    ...
                    >
                      <p class="mb-0">
                        ¿Cuál es el mejor aseo para tus mascotas?
                      </p>
                      <i class="fa" aria-hidden="true"></i>
                    </button>
                  </h2>
              ...
              <div class="card">
                <div class="card-header p-0" id="headingFour" role="tab">
                  <h2 class="mb-0">
                    ...
                    >
                      <p class="mb-0">
                        ¿Cuáles son los requisitos para cuidar mascotas?
                      </p>
                      <i class="fa" aria-hidden="true"></i>
                    </button>
                  </h2>
                ...
                >
                  <div class="card-body py-3 px-0">
                    <p>
                      Muy lejos, detrás de las montañas de palabras, lejos de
                      los países Vokalia y Consonantia, viven los textos ciegos.
                      Separados viven en Bookmarksgrove, justo en la costa de
                      los Semánticos, un gran océano de lenguaje.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>Clientes Felices &amp; Opiniones</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4 ftco-animate">
            <div class="block-7">
              <div
                class="img"
                style="background-image: url(images/pricing-1.jpg)"
              ></div>
              <div class="text-center p-4">
                ...
                <ul class="pricing-text mb-5">
                  <li>
                    <span class="fa fa-check mr-2"></span>5 Paseos para Perros
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>3 Visitas al
                    Veterinario
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>3 Spa para Mascotas
                  </li>
                  <li>
                    <span class="fa fa-check mr-2"></span>Soporte Gratuito
                  </li>
                </ul>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="block-7">
              <div
                class="img"
                style="background-image: url(images/pricing-2.jpg)"
              ></div>
              <div class="text-center p-4">
                <span class="excerpt d-block">Negocios</span>
                <span class="price"
          ...
          <div class="col-md-4 ftco-animate">
            <div class="block-7">
              <div
                class="img"
                style="background-image: url(images/pricing-3.jpg)"
              ></div>
              <div class="text-center p-4">
          ...
          <div class="col-md-4 ftco-animate">
            ...
            >
              ...
              <div class="desc w-100 px-4">
                <div class="text w-100 mb-3">
                  <span>Perro</span>
                  <h2><a href="work-single.html">Pomerania</a></h2>
                </div>
              </div>
            </div>
          </div>
          <div class="col-md-4 ftco-animate">
            ...
            >
              ...
              <div class="desc w-100 px-4">
                <div class="text w-100 mb-3">
                  <span>Gato</span>
                  <h2><a href="work-single.html">Gato Sphynx</a></h2>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div class="desc w-100 px-4">
                <div class="text w-100 mb-3">
                  <span>Gato</span>
                  <h2>
                    <a href="work-single.html">Gato Británico de Pelo Corto</a>
                  </h2>
                </div>
              </div>
            </div>
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text p-4">
                <div class="meta mb-2">
                  <div><a href="#">Abril 07, 2020</a></div>
                ...
                <h3 class="heading">
                  <a href="#"
                    >Incluso el todopoderoso Pointing no tiene control sobre los
                    textos ciegos</a
                  >
                </h3>
              </div>
                    ...
                    <div class="form-field">
                      <div class="select-wrap">
                        ...
                        >
                          ...
                          <option value="">Peluquería para Mascotas</option>
                          <option value="">Guardería de Mascotas</option>
                        </select>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
            <h2 class="footer-heading">Veterinaria Smile Pet</h2>
            <p>
              Un pequeño río llamado Duden fluye junto a su lugar y lo abastece
              con la necesaria regelialia.
            </p>
          ...
          <div class="col-md-6 col-lg-3 mb-4 mb-md-0">
            ...
            <div class="block-21 mb-4 d-flex">
              ...
              <div class="text">
                <h3 class="heading">
                  <a href="#"
                    >Incluso el todopoderoso Pointing no tiene control sobre</a
                  >
                </h3>
                <div class="meta">
                  <div>
                    <a href="#"
                      ><span class="icon-calendar"></span> Abril 7, 2020</a
                    >
                  </div>
                  <div>
